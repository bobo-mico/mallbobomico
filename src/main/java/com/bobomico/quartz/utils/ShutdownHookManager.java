 ...
 * @URL: https://github.com/huangyueranbbc/QuartzUtils/blob/QuartzUtils_v1.0.0/src/main/java/com/hyr/quartz/utils/ShutdownHookManager.java
 * @Author: DELL
 * @Date: 2019/4/30  12:32
 * @Description:
 * @version:
 */
